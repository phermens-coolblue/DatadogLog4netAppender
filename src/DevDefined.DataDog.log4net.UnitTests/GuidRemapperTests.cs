...
namespace DevDefined.DataDog.log4net.UnitTests
{
    public class GuidRemapperTests
    {
        ...
        public void RemapSomeGuids_WhenGuidsUppercase_ReturnsStringWithSameGuidsReplacedWithSameSentinels()
        {
            PAssert.IsTrue(
                () =>
                    "abc 00000001-0000-0000-0000-000000000000 00000002-0000-0000-0000-000000000000 00000001-0000-0000-0000-000000000000 xyz" ==
                    _mapper.RemampGuids(
                        "abc 47E26F75-9BC2-4996-9D37-8A981766FDC2 9BCD406E-2CEA-49DF-9EDC-38EB0009DC9F 47E26F75-9BC2-4996-9D37-8A981766FDC2 xyz"));
        }
